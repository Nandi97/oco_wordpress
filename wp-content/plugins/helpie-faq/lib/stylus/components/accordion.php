...
if (!class_exists('\Stylus\Components\Accordion')) {
    ...
    class Accordion
    {
        ...
        public function get_single_item($props, $collectionProps)
        {
            ...
            $html .= '<div class="accordion__header ' . esc_attr($accordion__header_classes) . '" data-id="' . esc_attr($id) . '" data-item="' . esc_attr($url_attribute) . '" style="' . $accordion_styles['header_background'] . '" data-tags="' . esc_attr($tags) . '">';
